...
class ExperimentBuilder(object):
    def __init__(self, args, dataloader_dict, model, device):
        """
    ...
    def build_summary_dict(self, total_losses, phase, summary_losses=None):
        ...
        for key in total_losses:
            ...
            summary_losses["{}_{}_std".format(phase, key)] = np.std(
                total_losses[key]
            )
    ...
    def train_iteration(
        ...
        losses, _ = self.model.run_train_iter(
    ...
    def evaluation_iteration(self, val_sample, total_losses, pbar_val, phase):
        ...
        val_losses = self.build_summary_dict(
            total_losses=total_losses, phase=phase
        )
    ...
    def pack_and_save_metrics(
        ...
        print(
            "epoch {} -> {}".format(
                epoch_summary_losses["epoch"], epoch_summary_string
            )
        )
