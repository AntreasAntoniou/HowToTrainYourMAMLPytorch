...
def get_args():
    ...
    parser.add_argument(
        "--num_dataprovider_workers", nargs="?", type=int, default=4
    )
    ...
    parser.add_argument(
        "--dataset_path", type=str, default="datasets/omniglot_dataset"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.001,
        help="Learning rate of overall MAML system",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Learning rate per task gradient step",
    )
    ...
    for key in list(args_dict.keys()):
        ...
        if key == "dataset_path":
            args_dict[key] = os.path.join(
                os.environ["DATASET_DIR"], args_dict[key]
            )
